...
impl PackgeBmc {
    ...
    pub async fn itinerary_day_create(
        ctx: &Ctx,
        mm: &ModelManager,
    ...
    pub async fn itinerary_day_location(
        ctx: &Ctx,
        mm: &ModelManager,
    ...
    pub async fn package_itinerary_create(
        ctx: &Ctx,
        mm: &ModelManager,
    ...
    pub async fn package_pricing_create(
        ctx: &Ctx,
        mm: &ModelManager,
    ...
    pub async fn optional_activity_create(
        ctx: &Ctx,
        mm: &ModelManager,
    ...
    pub async fn itinerary_day_optional_activity_create(
        ctx: &Ctx,
        mm: &ModelManager,
    ...
    pub async fn package_inclusion_create(
        ctx: &Ctx,
        mm: &ModelManager,
